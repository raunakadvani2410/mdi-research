---
title: 'ACS Demographic Data Extraction'
...
```{r}
write.csv(combined_data, "../../data/raw/acs/acs_raw_merged.csv")
```
...
```{r}
write.csv(combined_data, "../../data/raw/acs/acs_5_demographics_raw.csv")
```
